#------------------------
# Note:
# 14137.2 output_shortlist.txt
# 14845.9 output_shortlist_old.txt
# About 95% overall score compared to the slightly larger and manually-curated list.
#------------------------
...
# inputFilename = 'cognateLanguage_output_shortlist_old.txt'
# inputFilename = 'output.txt'
inputFilename = sys.argv[1] # so you can do this in terminal: python evaluator_old.py output.txt
...
for line in data:
    if ',' in line:
        ...
        overall_score += score1 + score2 # - score3

print('\n\t' + inputFilename + '\n\t' + str(overall_score) + ' = rough overall score\n')
