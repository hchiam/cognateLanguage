...
| 13805.7 | Using the various trade-offs discussed in this README.md
| 14845.9 | "Curated" output (i.e. includes manually-improved words).
...
The initial consonants of words also seem most stable across related languages.  Example:  "milk" in French, Italian, Spanish, and Portuguese are lait, latte, leche, and leite, respectively, and all start with "l" and then a vowel, and then usually later followed by "t".  
